          ...
          <div className='flex flex-col items-center justify-center bg-[#e6ae60] p-10 font-serif'>
            ...
            <div>
              <p className='px-5 text-center text-amber-900 md:w-2xl'>
                ...
                jugaron diversos juegos para competir en equipo, donde salieron
                a la luz estrategias tramposas, buenas ideas y sobre todo risas
                y gritos. <br /> Con un menu digno de los mejores restaurantes,
