export default function Navbar(){
    return(
        ...
        <a href="/cafe"> <img src="/imagenes/camara2.png" className="h-10 hover:scale-107 transition-transform duration-300 ease-in-out hover:cursor-pointer rotate-3"></img></a>
